...
public class AliOSSUtils {
    ...
    public String upload(MultipartFile file) throws IOException, ClientException {
        ...
        String endpoint = aliOSSProperties.getEndpoints();
        ...
        //上传文件到 OSS
        OSS ossClient = new OSSClientBuilder().build(endpoint, CredentialsProviderFactory.newEnvironmentVariableCredentialsProvider());
